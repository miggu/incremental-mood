...
(function ($) {
  $.fn.flipbook = function (options) {
    ...
    return this.each(function () {
      ...
      var loop = false; // ñapa por culpa de claudia

      if (loop === "true") {
        loop = true;
        conlole.log("loop true"); //miguel
      } else if (loop === "false") {
        loop = false;
        conlole.log("loop false"); //miguel
      }
      ...
      function imageName(frame) {
        return (
          imagesFrontString + padFrame(frame, framePadding) + imagesEndString
        );
      }
